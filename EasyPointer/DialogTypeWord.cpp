...
DialogTypeWord::DialogTypeWord(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::DialogTypeWord)
{
    ui->setupUi(this);
...
void DialogTypeWord::changeEvent(QEvent *pEvt)
{
...
QString DialogTypeWord::getMontherLang(bool bIsTyping)
{
    if(bIsTyping)
    {
...
QString DialogTypeWord::getMontherAccent(bool bIsTyping)
{
    if(bIsTyping)
    {
        int nIndex = ui->comboBoxLang1->currentIndex();
...
QString DialogTypeWord::getTransLang1()
{
    int nIndex = ui->comboBoxLang2->currentIndex();
    QJsonObject Item = m_trans[nIndex].toObject() ;
...
QString DialogTypeWord::getTransLang2()
{
